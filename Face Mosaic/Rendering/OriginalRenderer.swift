...
class OriginalRenderer: NSObject, Renderer {
    ...
    var seedData: Data = "Seed".data(using: .utf8)! {
        didSet {
    ...
    func draw(in view: MTKView) {
        ...
        if sceneNeedsLayedOut {
            ...
            let textureSize = float2(Float(canvasSize.width), Float(canvasSize.height))
